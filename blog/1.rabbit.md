...
Of course, the other application which can be implemented within Forth is the Forth text interpreter itself. In the [next article](2.bootstrap.md) we explore how this is done, see why it is a good idea, and resolve the bootstrapping issue into which we run.
